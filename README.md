...
* 🔥 **OpenRouter GPT Model Integration** (`gpt-4o-mini` by default)
* 🧠 **Send user prompts** through a simple form
* ⚡ **Flask backend** with GET/POST support
* 📝 **Jinja2 HTML template** for showing prompts & results
* 🔒 **Easy API key setup** (just add your key in the variable)
* 🛠️ Clean architecture — perfect for learning or extending
* ❗ Basic error handling for invalid API responses
...
2. Flask sends it to **OpenRouter’s Chat Completion API**
